...
export class AuthService {
    ...
    async login(dto: LoginDto) {
        ...
        if (!passwordMatch) throw new UnauthorizedException('Email ou mot de passe incorrect');
    ...
    private async generateTokens(userId: string, email: string): Promise<AuthTokens & { refreshToken: string }> {
